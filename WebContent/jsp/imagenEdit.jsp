...
<body>
	<header>
		<h1>Gestor Imágenes SVG en eXist - SW-2020</h1>
		<h3>Edición de la imagen: <%=svgName%></h3>
	</header>
	
	<nav class="menu">
		<a href="./html/index.html"> Inicio </a>
		<a onclick="document.getElementById('myform').submit();">Volver </a>
  </nav>
	<form id="myform" method="POST" action="./apiLR">
	<input type="hidden" name="collection" value="<%=collection%>" /></form>
	...
	<table class="edicion">
		...
		<tr class="edicion">
			<td class="edicion">
			  <object class="edicion" data=<%=imagenURI%>	type="image/svg+xml"></object></td>
